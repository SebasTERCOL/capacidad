...
DROP FUNCTION IF EXISTS public.calculate_schedule_with_capacity(text[], numeric[], integer, integer, numeric, jsonb);

-- Recreate with Punzonado exclusion for non-CMB refs
